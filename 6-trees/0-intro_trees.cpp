/*
    Trees
        1. What is a Tree ?
            ...
            Graph is collection of Vertices (nodes) and Edges.
   ...
   stored in a SEQUENTIAL manner (one after the another)
    ...
    Binary Tree
        ...
        2. A Tree is considered a Binary Tree IF it satisfies all 3 conditions:
            ...
            2.2 every PARENT node has AT MOST 2 CHILDREN(it can be 0, 1, or 2
   children) 2.3 EXACTLY 1 PATH from ROOT node to any other node In other words,
   there should be NO CYCLE in the Tree.
    ...
    HEIGHT of NODE x: MAX DISTANCE from node x to the leaf node.
    ...
    Real World Examples:
        ...
        Trees are used to organize HIREARCHICAL data like
            1. files directory
            2. html dom
            3. AI (example minimax tree): playing against itself what happens
               next
    ...
    Other types of trees
        ...
        => Red Black Trees
        => 2-3 Trees
        => N-ary Tree : an N-ary tree is a rooted tree in which each node has no
